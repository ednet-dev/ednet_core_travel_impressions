...
void testTravelImpressionsTravelers(TravelDomain travelDomain,
    ImpressionsModel impressionsModel, Travelers travelers) {
  ...
  group("Testing Travel.Impressions.Traveler", () {
    ...
    test("Find traveler by attribute", () {
      var randomTraveler = travelers.random();
      var traveler = travelers.firstWhereAttribute(
          "description", randomTraveler.description);
      expect(traveler, isNotNull);
    ...
    test("Select travelers by attribute", () {
      var randomTraveler = travelers.random();
      var selectedTravelers = travelers.selectWhereAttribute(
          "description", randomTraveler.description);
      expect(selectedTravelers.isEmpty, isFalse);
      selectedTravelers.forEach(
          (se) => expect(se.description, equals(randomTraveler.description)));
    ...
    test("Select travelers by required attribute", () {
      ...
      expect(selectedTravelers.isEmpty, isFalse);
      selectedTravelers.forEach(
          (se) => expect(se.password, equals(randomTraveler.password)));
    ...
    test("Copy travelers", () {
      ...
      copiedTravelers
          .forEach((e) => expect(e, equals(travelers.singleWhereOid(e.oid))));
      copiedTravelers.forEach(
          (e) => expect(e, isNot(same(travelers.singleWhereId(e.id!)))));
    ...
    test("Update traveler id with success", () {
      ...
      var attribute =
          randomTraveler.concept.attributes.singleWhereCode("email");
    ...
    test("Update traveler non id attribute with failure", () {
      ...
      expect(() => travelers.update(randomTraveler, afterUpdateEntity),
    ...
    test("Copy Equality", () {
      ...
      expect(
          randomTraveler.description, equals(randomTravelerCopy.description));
    ...
    test("Reactions to traveler actions", () {
      ...
      var setAttributeCommand =
          SetAttributeCommand(session, traveler, "password", 'cloud');
...
void main() {
  ...
  TravelDomain travelDomain =
      repository.getDomainModels("Travel") as TravelDomain;
  assert(travelDomain != null);
  ImpressionsModel impressionsModel =
      travelDomain.getModelEntries("Impressions") as ImpressionsModel;
